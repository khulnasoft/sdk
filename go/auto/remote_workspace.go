...
// GitRepo. Khulnasoft operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
// Khulnasoft operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
// specified GitRepo. Khulnasoft operations on the stack (Preview, Update, Refresh, and Destroy) are performed remotely.
...
type remoteWorkspaceOptions struct {
	...
	// AgentPoolID is the agent pool (also called deployment runner pool) to use for the remote Khulnasoft operation.
	AgentPoolID string
}
...
// RemotePreRunCommands is an optional list of arbitrary commands to run before the remote Khulnasoft operation is invoked.
