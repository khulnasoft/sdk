...
// github.com/sdk/go/auto workspace.Import(context.Context, ...optimport.Option)
package optimport
...
// Protect configures whether to set imported resources as protected in the Khulnasoft state.
...
type ImportResource struct {
	...
	// The type token of the Khulnasoft resource
	Type string `json:"type,omitempty"`
	// The name of the resource
	Name string `json:"name,omitempty"`
	// The name of the resource used in the generated Khulnasoft program from the import
