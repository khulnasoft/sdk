...
// Workspace is the execution context containing a single Khulnasoft project, a program, and multiple stacks.
...
type Workspace interface {
	...
	WorkDir() string
	// KhulnasoftCommand returns the KhulnasoftCommand instance that is used to run KhulnasoftCommand CLI commands.
...
// ConfigValue is a configuration value used by a Khulnasoft program.
...
// ConfigOptions is a configuration option used by a Khulnasoft program.
// Allows to use the path flag while getting/setting the configuration.
type ConfigOptions struct {
	Path bool
}

// ConfigMap is a map of ConfigValue used by Khulnasoft programs.
...
// WhoAmIResult contains detailed information about the currently logged-in Khulnasoft identity.
