...
func TestRepr(t *testing.T) {
	...
	isAccept := cmdutil.IsTruthy(os.Getenv("KHULNASOFT_ACCEPT"))
	...
	// truth (if KHULNASOFT_ACCEPT is truthy) or load the expected results and validate against the actual results.
