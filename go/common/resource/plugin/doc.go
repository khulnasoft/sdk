...
/*
Package plugin defines the plugin interfaces used by the Khulnasoft engine and provides basic plugin management for
out-of-process plugin implementations that communicate over gRPC.

Providers

The Provider type defines the interface that must be implemented by a Khulnasoft resource provider. Resource providers
...
a number of quirks intended to retain backwards compatibility with older versions of the Khulnasoft engine. These factors
