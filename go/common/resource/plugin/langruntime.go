...
// The programs root directory, i.e. where the Khulnasoft.yaml file is.
...
type LanguageRuntime interface {
	...
	// as Khulnasoft.yaml and package.json.
...
// These are the languages dependencies, they are not necessarily Khulnasoft packages.
...
// Key is the key as used in runtime.options.<Key> in the Khulnasoft.yaml file.
