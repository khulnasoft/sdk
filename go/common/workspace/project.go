...
// ProjectTemplate is a Khulnasoft project template manifest.
...
//
// To explicitly use the Khulnasoft Cloud backend, use URL "https://api.khulnasoft.com"
...
// Project is a Khulnasoft project manifest.
//
...
type Project struct {
	...
	// StackConfigDir indicates where to store the Khulnasoft.<stack-name>.yaml files, combined with the folder
	// Khulnasoft.yaml is in.
...
const KhulnasoftTagsConfigKey = "khulnasoft:tags"
