...
// apitype.PluginKind represents a kind of a plugin that may be dynamically loaded and used by Khulnasoft.
...
const (
	...
	// ConverterPlugin is a plugin that can be used to convert from other ecosystems to Khulnasoft.
