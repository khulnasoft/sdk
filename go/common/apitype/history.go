...
const (
	// UpdateUpdate is the prototypical Khulnasoft program update.
	...
	// RenameUpdate is an update that changes the stack name or project name of a Khulnasoft program.
	// NOTE: Do not remove this type - it is used by Khulnasoft Cloud code.
...
// OpType describes the type of operation performed to a resource managed by Khulnasoft.
//
...
// GetHistoryResponse is the response from the Khulnasoft Service when requesting
// a stack's history.
