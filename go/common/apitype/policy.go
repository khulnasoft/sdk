...
type UpdatePolicyGroupRequest struct {
	...
	AddStack    *KhulnasoftStackReference `json:"addStack,omitempty"`
	RemoveStack *KhulnasoftStackReference `json:"removeStack,omitempty"`
...
// KhulnasoftStackReference contains the StackName and ProjectName of the stack.
type KhulnasoftStackReference struct {
	Name           string `json:"name"`
