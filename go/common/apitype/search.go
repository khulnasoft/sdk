...
type KhulnasoftQueryResponse struct {
	Query string `json:"query"`
}

type KhulnasoftQueryRequest struct {
	Query string `url:"query"`
}

// ParseQueryParams takes a list of parameters passed into the CLI
// Search commands (in the form of a Khulnasoft query)
// and returns a KhulnasoftQueryRequest struct that can be used to make a request
// to the Khulnasoft API.
//
// See https://www.khulnasoft.com/docs/khulnasoft-cloud/insights/search/#query-syntax for reference
func ParseQueryParams(rawParams []string) *KhulnasoftQueryRequest {
	return &KhulnasoftQueryRequest{Query: strings.Join(rawParams, " ")}
}
