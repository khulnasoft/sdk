...
import (
	...
	"github.com/khulnasoft/sdk/go/common/util/env"
...
func init() {
	env.Global = env.MapStore{
		"KHULNASOFT_FOO": "1",
		// "KHULNASOFT_NOT_SET": explicitly not set
		"FOO":                    "bar",
		"KHULNASOFT_MY_INT":      "3",
		"KHULNASOFT_SECRET":      "hidden",
		"KHULNASOFT_SET":         "SET",
		"UNSET":                  "SET",
		"KHULNASOFT_ALTERNATIVE": "SET",
	}
}
...
var (
	...
	UnsetString = env.String("KHULNASOFT_UNSET", "Should be unset", env.Needs(SomeFalse))
...
func TestInt(t *testing.T) {
	...
	assert.Equal(t, 6, env.NewEnv(
		env.MapStore{"KHULNASOFT_MY_INT": "6"},
	).GetInt(AnInt))
}
