...
// Returns a Khulnasoft-formatted tracing endpoint pointing to this
// server.
//
...
// `KHULNASOFT_TRACING_MEMSTATS_POLL_INTERVAL=1s` or similar. Consider
...
func collectMemStats(spanPrefix string) {
	...
	interval := os.Getenv("KHULNASOFT_TRACING_MEMSTATS_POLL_INTERVAL")
