...
import "github.com/khulnasoft/sdk/go/common/util/env"
...
// That Khulnasoft is running in experimental mode.
//
...
var DebugGRPC = env.String("DEBUG_GRPC", `Enables debug tracing of Khulnasoft gRPC internals.
...
// Environment variables which affect Khulnasoft AI integrations
var (
	AIServiceEndpoint = env.String("AI_SERVICE_ENDPOINT", "Endpoint for Khulnasoft AI service")
)
