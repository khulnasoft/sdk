...
// Resource represents a cloud resource managed by Khulnasoft.
...
type ResourceOptions struct {
	...
	// instead of Khulnasoft's default behavior of creating the replacement
	// before performing deletion.
	DeleteBeforeReplace bool

	// DependsOn lists additional explicit dependencies for the resource
	// in addition to those tracked automatically by Khulnasoft.
	DependsOn []Resource
	...
	// in the cloud provider, even if it's deleted from Khulnasoft.
	RetainOnDelete bool
