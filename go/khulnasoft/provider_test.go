...
import (
	...
	rarchive "github.com/khulnasoft/sdk/go/common/resource/archive"
	rasset "github.com/khulnasoft/sdk/go/common/resource/asset"
...
func TestConstruct_await(t *testing.T) {
	...
	// Note: a given output may or may not be associated with the Khulnasoft context, depending on how it's made,
...
func TestCall_await(t *testing.T) {
	...
	// Note: a given result may or may not be associated with the Khulnasoft context, depending on how it's made,
	// meaning that it may or may not be tracked by the context's waitgroup.
