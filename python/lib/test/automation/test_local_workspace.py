...
class TestLocalWorkspace(unittest.TestCase):
    def test_project_settings(self):
        for ext in extensions:
            ...
            self.assertEqual(settings.description, "A minimal Go Khulnasoft program")
    ...
    def test_list_stacks(self):
        mock_with_returned_stacks = KhulnasoftCommand()
    ...
    def test_install(self):
        class MockCmd(KhulnasoftCommand):
    ...
    def test_pytest_raises_does_not_hang(self):
        ...
        # https://github.com/khulnasoft/khulnasoft/issues/17133 where a test failure
