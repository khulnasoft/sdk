...
class LanghostTest(unittest.TestCase):
    ...
    Khulnasoft Engine gRPC endpoint and running the language host exactly the same
    way that the Khulnasoft CLI will. Once the program completes and the language host
