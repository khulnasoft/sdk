...
"""
Constant to represent the 'root stack' resource for a Khulnasoft application.  The purpose of this is
...
class Resource:
    ...
    def translate_input_property(self, prop: str) -> str:
        ...
        a format of their choosing before sending those properties to the Khulnasoft engine.
