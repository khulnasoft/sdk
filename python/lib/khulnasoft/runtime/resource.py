    ...
    async def do_get():
        try:
            ...
            accept_resources = os.getenv(
                "KHULNASOFT_DISABLE_RESOURCE_REFERENCES", ""
            ).upper() not in {"TRUE", "1"}
    ...
    async def do_register() -> None:
        try:
            ...
            if (
                ...
                raise Exception(
                    "The Khulnasoft CLI does not support the DeletedWith option. Please update the Khulnasoft CLI."
                )
        ...
        # throw an exception sometimes. This was causing Khulnasoft
