...
class Mocks(ABC):
    """
    Mocks is an abstract class that allows subclasses to replace operations normally implemented by the Khulnasoft engine with
...
def set_mocks(
    ...
    """
    set_mocks configures the Khulnasoft runtime to use the given mocks for testing.
    """
