...
import khulnasoft.alias_pb2
import khulnasoft.callback_pb2
import khulnasoft.source_pb2
import sys
import typing
...
class ReadResourceRequest(google.protobuf.message.Message):
    ...
    properties that exist on Khulnasoft resources as projected into the target language. It is important to call out that the
    ...
    @property
    def sourcePosition(self) -> khulnasoft.source_pb2.SourcePosition:
    ...
    def __init__(
        ...
        *,
        ...
        sourcePosition: khulnasoft.source_pb2.SourcePosition | None = ...,
        packageRef: builtins.str = ...,
    ) -> None: ...
...
class RegisterResourceRequest(google.protobuf.message.Message):
    ...
    @property
    def aliases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[khulnasoft.alias_pb2.Alias]:
    ...
    @property
    def transforms(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[khulnasoft.callback_pb2.Callback]:
    ...
    def __init__(
        ...
        *,
        ...
        pluginChecksums: collections.abc.Mapping[builtins.str, builtins.bytes] | None = ...,
        retainOnDelete: builtins.bool = ...,
        aliases: collections.abc.Iterable[khulnasoft.alias_pb2.Alias] | None = ...,
        deletedWith: builtins.str = ...,
        aliasSpecs: builtins.bool = ...,
        sourcePosition: khulnasoft.source_pb2.SourcePosition | None = ...,
        transforms: collections.abc.Iterable[khulnasoft.callback_pb2.Callback] | None = ...,
        supportsResultReporting: builtins.bool = ...,
        packageRef: builtins.str = ...,
    ) -> None: ...
