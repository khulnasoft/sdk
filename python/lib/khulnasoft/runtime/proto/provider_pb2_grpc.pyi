...
class ResourceProviderStub:
    ...
    Handshake: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.ProviderHandshakeRequest,
        khulnasoft.provider_pb2.ProviderHandshakeResponse,
    ]
    ...
    Parameterize: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.ParameterizeRequest,
        khulnasoft.provider_pb2.ParameterizeResponse,
    ]
    ...
    * *Extension parameterization*, in which a `Parameterize` call results in a schema that is a superset of the
    ...
    GetSchema: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.GetSchemaRequest,
        khulnasoft.provider_pb2.GetSchemaResponse,
    ]
    """GetSchema fetches the schema for this resource provider."""
    CheckConfig: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.CheckRequest,
        khulnasoft.provider_pb2.CheckResponse,
    ]
    ...
    DiffConfig: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.DiffRequest,
        khulnasoft.provider_pb2.DiffResponse,
    ]
    ...
    Configure: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.ConfigureRequest,
        khulnasoft.provider_pb2.ConfigureResponse,
    ]
    ...
    * Providers which implement `Handshake` *must* support flags such as `acceptSecrets` and `acceptResources`, and
    ...
    Invoke: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.InvokeRequest,
    ...
    Call: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.CallRequest,
    ...
    *may also populate default values* for resource inputs, returning them so that they may be passed to a subsequent
    ...
    Create: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.CreateRequest,
        khulnasoft.provider_pb2.CreateResponse,
    ]
    ...
    Read: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.ReadRequest,
        khulnasoft.provider_pb2.ReadResponse,
    ]
    ...
    Construct: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.ConstructRequest,
        khulnasoft.provider_pb2.ConstructResponse,
    ]
    ...
    * A full set of [resource options](https://www.khulnasoft.com/docs/iac/concepts/options/) that the component should
    ...
    Attach: grpc.UnaryUnaryMultiCallable[
        khulnasoft.plugin_pb2.PluginAttach,
        google.protobuf.empty_pb2.Empty,
    ]
    """Attach sends the engine address to an already running plugin."""
    GetMapping: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.GetMappingRequest,
        khulnasoft.provider_pb2.GetMappingResponse,
    ]
    """GetMapping fetches the mapping for this resource provider, if any. A provider should return an empty
    response (not an error) if it doesn't have a mapping for the given key.
    """
    GetMappings: grpc.UnaryUnaryMultiCallable[
        khulnasoft.provider_pb2.GetMappingsRequest,
        khulnasoft.provider_pb2.GetMappingsResponse,
    ]
...
class ResourceProviderServicer(metaclass=abc.ABCMeta):
    ...
    def Handshake(
        self,
        request: khulnasoft.provider_pb2.ProviderHandshakeRequest,
    ...
    def Parameterize(
        self,
        request: khulnasoft.provider_pb2.ParameterizeRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.ParameterizeResponse:
        """`Parameterize` is the primary means of supporting [parameterized providers](parameterized-providers), which allow
        a caller to change a provider's behavior ahead of its [configuration](khulnasoftrpc.ResourceProvider.Configure) and
    ...
    def GetSchema(
        self,
        request: khulnasoft.provider_pb2.GetSchemaRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.GetSchemaResponse:
        """GetSchema fetches the schema for this resource provider."""
    ...
    def CheckConfig(
        self,
        request: khulnasoft.provider_pb2.CheckRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.CheckResponse:
        """`CheckConfig` validates a set of configuration inputs that will be passed to this provider instance.
        `CheckConfig` is to provider resources what [](khulnasoftrpc.ResourceProvider.Check) is to individual resources, and
    ...
    def DiffConfig(
        self,
        request: khulnasoft.provider_pb2.DiffRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.DiffResponse:
        """`DiffConfig` compares an existing ("old") provider configuration with a new configuration and computes the
        difference (if any) between them. `DiffConfig` is to provider resources what [](khulnasoftrpc.ResourceProvider.Diff)
    ...
    def Configure(
        self,
        request: khulnasoft.provider_pb2.ConfigureRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.ConfigureResponse:
        """`Configure` is the final stage in configuring a provider instance. Callers may supply two sets of data:
    ...
    def Invoke(
        self,
        request: khulnasoft.provider_pb2.InvokeRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.InvokeResponse:
        """Invoke dynamically executes a built-in function in the provider."""
    ...
    def Call(
        self,
        request: khulnasoft.provider_pb2.CallRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.CallResponse:
        """Call dynamically executes a method in the provider associated with a component resource."""
    ...
    def Create(
        self,
        request: khulnasoft.provider_pb2.CreateRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.CreateResponse:
        """`Create` provisions a new instance of the specified [(custom) resource](custom-resources). It returns a
        provider-assigned ID for the resource as well as the output properties that arose from the creation properties.
    ...
    def Read(
        self,
        request: khulnasoft.provider_pb2.ReadRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.ReadResponse:
        """`Read` reads the current live state associated with a resource identified by the supplied state. The given state
        must be sufficient to uniquely identify the resource. This is typically just the resource ID, but may also
    ...
    def Update(
        self,
        request: khulnasoft.provider_pb2.UpdateRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.UpdateResponse:
        """`Update` updates an existing resource according to a new set of inputs, returning a new set of output properties."""
    ...
    def Delete(
        self,
        request: khulnasoft.provider_pb2.DeleteRequest,
        context: grpc.ServicerContext,
    ) -> google.protobuf.empty_pb2.Empty:
        """`Delete` deprovisions an existing resource as specified by its ID. `Delete` should be transactional/atomic -- if
        a call to `Delete` fails, it must be the case that the resource was *not* deleted and can be assumed to still
    ...
    def Construct(
        self,
        request: khulnasoft.provider_pb2.ConstructRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.ConstructResponse:
        """`Construct` provisions a new [component resource](component-resources). Providers that implement `Construct` are
        referred to as [component providers](component-providers). `Construct` is to component resources what
    ...
    def Attach(
        self,
        request: khulnasoft.plugin_pb2.PluginAttach,
        context: grpc.ServicerContext,
    ) -> google.protobuf.empty_pb2.Empty:
        """Attach sends the engine address to an already running plugin."""
    ...
    def GetMapping(
        self,
        request: khulnasoft.provider_pb2.GetMappingRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.GetMappingResponse:
        """GetMapping fetches the mapping for this resource provider, if any. A provider should return an empty
        response (not an error) if it doesn't have a mapping for the given key.
    ...
    def GetMappings(
        self,
        request: khulnasoft.provider_pb2.GetMappingsRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.provider_pb2.GetMappingsResponse:
        """GetMappings is an optional method that returns what mappings (if any) a provider supports. If a provider does not
        implement this method the engine falls back to the old behaviour of just calling GetMapping without a name.
