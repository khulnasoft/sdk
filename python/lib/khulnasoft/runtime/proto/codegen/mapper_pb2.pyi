...
class GetMappingRequest(google.protobuf.message.Message):
    ...
    KHULNASOFT_PROVIDER_FIELD_NUMBER: builtins.int
    provider: builtins.str
    """the provider name for the mapping being requested."""
    khulnasoft_provider: builtins.str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["provider", b"provider", "khulnasoft_provider", b"khulnasoft_provider"]) -> None: ...
