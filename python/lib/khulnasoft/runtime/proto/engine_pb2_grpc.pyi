...
class EngineStub:
    ...
    Log: grpc.UnaryUnaryMultiCallable[
        khulnasoft.engine_pb2.LogRequest,
        google.protobuf.empty_pb2.Empty,
    ]
    """Log logs a global message in the engine, including errors and warnings."""
    GetRootResource: grpc.UnaryUnaryMultiCallable[
        khulnasoft.engine_pb2.GetRootResourceRequest,
        khulnasoft.engine_pb2.GetRootResourceResponse,
    ]
    """GetRootResource gets the URN of the root resource, the resource that should be the root of all
    otherwise-unparented resources.
    """
    SetRootResource: grpc.UnaryUnaryMultiCallable[
        khulnasoft.engine_pb2.SetRootResourceRequest,
        khulnasoft.engine_pb2.SetRootResourceResponse,
    ]
    """SetRootResource sets the URN of the root resource."""
    StartDebugging: grpc.UnaryUnaryMultiCallable[
        khulnasoft.engine_pb2.StartDebuggingRequest,
        google.protobuf.empty_pb2.Empty,
    ]
...
class EngineServicer(metaclass=abc.ABCMeta):
    ...
    def Log(
        self,
        request: khulnasoft.engine_pb2.LogRequest,
    ...
    def GetRootResource(
        self,
        request: khulnasoft.engine_pb2.GetRootResourceRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.engine_pb2.GetRootResourceResponse:
        """GetRootResource gets the URN of the root resource, the resource that should be the root of all
        otherwise-unparented resources.
    ...
    def SetRootResource(
        self,
        request: khulnasoft.engine_pb2.SetRootResourceRequest,
        context: grpc.ServicerContext,
    ) -> khulnasoft.engine_pb2.SetRootResourceResponse:
        """SetRootResource sets the URN of the root resource."""
    ...
    def StartDebugging(
        self,
        request: khulnasoft.engine_pb2.StartDebuggingRequest,
        context: grpc.ServicerContext,
    ) -> google.protobuf.empty_pb2.Empty:
        """StartDebugging indicates to the engine that the program has started under a debugger, and the engine
        should notify the user of how to connect to the debugger.
