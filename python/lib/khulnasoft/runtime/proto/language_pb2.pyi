...
import khulnasoft.codegen.hcl_pb2
...
class GetRequiredPluginsResponse(google.protobuf.message.Message):
    ...
    @property
    def plugins(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[khulnasoft.plugin_pb2.PluginDependency]:
        """a list of plugins required by this program."""
    def __init__(
        self,
        *,
        plugins: collections.abc.Iterable[khulnasoft.plugin_pb2.PluginDependency] | None = ...,
    ) -> None: ...
...
class GetRequiredPackagesResponse(google.protobuf.message.Message):
    ...
    @property
    def packages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[khulnasoft.plugin_pb2.PackageDependency]:
        """a list of packages required by this program."""
    def __init__(
        self,
        *,
        packages: collections.abc.Iterable[khulnasoft.plugin_pb2.PackageDependency] | None = ...,
    ) -> None: ...
...
class GenerateProgramResponse(google.protobuf.message.Message):
    ...
    SOURCE_FIELD_NUMBER: builtins.int
    @property
    def diagnostics(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[khulnasoft.codegen.hcl_pb2.Diagnostic]:
    ...
    def __init__(
        self,
        *,
        diagnostics: collections.abc.Iterable[khulnasoft.codegen.hcl_pb2.Diagnostic] | None = ...,
