...
"""
Utility functions for logging messages to the diagnostic stream of the Khulnasoft CLI.
"""
...
def debug(
    ...
    """
    Logs a message to the Khulnasoft CLI's debug channel, associating it with a resource
    and stream_id if provided.

    :param str msg: The message to send to the Khulnasoft CLI.
    :param Optional[Resource] resource: If provided, associate this message with the given resource in the Khulnasoft CLI.
...
def info(
    ...
    """
    Logs a message to the Khulnasoft CLI's info channel, associating it with a resource
    and stream_id if provided.
...
def warn(
    ...
    """
    Logs a message to the Khulnasoft CLI's warning channel, associating it with a resource
    and stream_id if provided.
...
def error(
    ...
    """
    Logs a message to the Khulnasoft CLI's error channel, associating it
    with a resource and stream_id if provided.

    Consider raising an exception after calling error to stop the Khulnasoft program.
