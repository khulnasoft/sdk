...
func TestDetermineKhulnasoftPackages(t *testing.T) {
	t.Parallel()
	...
	t.Run("empty", func(t *testing.T) {
		...
		assert.NoError(t, err)
		packages, err := determineKhulnasoftPackages(context.Background(), toolchain.PythonOptions{
	...
	t.Run("non-empty", func(t *testing.T) {
		...
		// Install the local Khulnasoft SDK into the virtual environment.
	...
	t.Run("khulnasoftplugin-resource-false", func(t *testing.T) {
		...
		// The package should be considered a Khulnasoft package since its name is prefixed with "khulnasoft_".
		packages, err := determineKhulnasoftPackages(context.Background(), toolchain.PythonOptions{
			Toolchain:  toolchain.Pip,
			Root:       cwd,
			Virtualenv: "venv",
	...
	t.Run("khulnasoft-policy", func(t *testing.T) {
		...
		// The package should not be considered a Khulnasoft package since it is hardcoded not to be,
