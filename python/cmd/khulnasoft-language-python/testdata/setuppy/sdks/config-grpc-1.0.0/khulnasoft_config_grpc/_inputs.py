...
if not MYPY:
    class Tbool1ArgsDict(TypedDict):
        x: NotRequired[khulnasoft.Input[bool]]
elif False:
...
if not MYPY:
    class Tint1ArgsDict(TypedDict):
        x: NotRequired[khulnasoft.Input[int]]
elif False:
...
if not MYPY:
    class Tnum1ArgsDict(TypedDict):
        x: NotRequired[khulnasoft.Input[float]]
elif False:
...
if not MYPY:
    class TsecretBool1ArgsDict(TypedDict):
        secret_x: NotRequired[khulnasoft.Input[bool]]
elif False:
...
if not MYPY:
    class TsecretInt1ArgsDict(TypedDict):
        secret_x: NotRequired[khulnasoft.Input[int]]
elif False:
...
if not MYPY:
    class TsecretNum1ArgsDict(TypedDict):
        secret_x: NotRequired[khulnasoft.Input[float]]
elif False:
...
if not MYPY:
    class TsecretString1ArgsDict(TypedDict):
        secret_x: NotRequired[khulnasoft.Input[str]]
elif False:
...
if not MYPY:
    class Tstring1ArgsDict(TypedDict):
        x: NotRequired[khulnasoft.Input[str]]
elif False:
