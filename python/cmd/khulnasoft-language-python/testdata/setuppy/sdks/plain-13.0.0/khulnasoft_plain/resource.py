...
class Resource(khulnasoft.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data: Optional[khulnasoft.InputType['DataArgs']] = None,
                 non_plain_data: Optional[khulnasoft.Input[khulnasoft.InputType['DataArgs']]] = None,
                 __props__=None):
        """
        Create a Resource resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param khulnasoft.ResourceOptions opts: Options for the resource.
        :param khulnasoft.Input[khulnasoft.InputType['DataArgs']] non_plain_data: A non plain input to compare against the plain inputs, as well as testing plain/non-plain nesting.
        """
        ...
    @overload
    def __init__(__self__,
