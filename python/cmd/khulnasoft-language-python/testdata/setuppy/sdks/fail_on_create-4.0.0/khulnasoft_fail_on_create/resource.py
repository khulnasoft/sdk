...
class ResourceArgs:
    ...
    @property
    @khulnasoft.getter
    def value(self) -> khulnasoft.Input[bool]:
        return khulnasoft.get(self, "value")

    @value.setter
    def value(self, value: khulnasoft.Input[bool]):
...
class Resource(khulnasoft.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 value: Optional[khulnasoft.Input[bool]] = None,
                 __props__=None):
        """
    ...
    @property
    @khulnasoft.getter
    def value(self) -> khulnasoft.Output[bool]:
        return khulnasoft.get(self, "value")
