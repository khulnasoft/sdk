...
def _get_semver_version():
    ...
    # Unfortunately, PEP440 and semver differ slightly in incompatible ways. The Khulnasoft engine expects
...
# of the Khulnasoft SDK (<3.121.0) that does not include the `deprecated` decorator.
...
async def get_package():
	...
	if _package_ref is None or _package_ref is ...:
		raise Exception("The Khulnasoft CLI does not support parameterization. Please update the Khulnasoft CLI.")
	return _package_ref
