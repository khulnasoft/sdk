...
export const disableResourceReferences: boolean =
    process.env.KHULNASOFT_DISABLE_RESOURCE_REFERENCES === "1" ||
    (process.env.KHULNASOFT_DISABLE_RESOURCE_REFERENCES ?? "").toUpperCase() === "TRUE";

/**
 * @internal
 */
export const errorOutputString: boolean =
    process.env.KHULNASOFT_ERROR_OUTPUT_STRING === "1" || process.env.KHULNASOFT_ERROR_OUTPUT_STRING?.toUpperCase() === "TRUE";
