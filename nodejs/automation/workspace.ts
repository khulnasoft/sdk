...
import { KhulnasoftCommand } from "./cmd";
...
/**
 * {@link Workspace} is the execution context containing a single Khulnasoft
...
export interface Workspace {
     ...
     */
    readonly khulnasoftCommand: KhulnasoftCommand;
     ...
     * supplied to every Khulnasoft command.
     */
     ...
     * create/modify a `Khulnasoft.stack.yaml`)
     */
     ...
     * {@link Workspace} as `Khulnasoft.<stack>.yaml` files.
     *
     * @param opts
...
/**
 * A Khulnasoft program as an inline function (in process).
 */
export type KhulnasoftFn = () => Promise<Record<string, any> | void>;

/**
 * The currently logged-in Khulnasoft access token.
 */
