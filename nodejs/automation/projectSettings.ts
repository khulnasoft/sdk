...
/**
 * A Khulnasoft project manifest. It describes metadata applying to all sub-stacks
...
/**
 * Supported Khulnasoft program language runtimes.
 */
...
/**
 * Configuration for the project's Khulnasoft state storage backend.
 */
