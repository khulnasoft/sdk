...
export class RemoteWorkspace {
     ...
     * code from the specified Git repository. Khulnasoft operations on the stack
     ...
     * with source code from the specified Git repository. Khulnasoft operations on
     * the stack (preview, update, refresh, and destroy) are performed remotely.
     *
     * @param args
     *  A set of arguments to initialize a RemoteStack with a remote Khulnasoft program from a Git repository.
     * @param opts
     *  Additional customizations to be applied to the Workspace.
     */
...
/**
 * Description of a stack backed by a remote Khulnasoft program in a Git repository.
 */
export interface RemoteGitProgramArgs {
    ...
    /**
     * An optional path relative to the repo root specifying location of the Khulnasoft program.
     */
    projectPath?: string;
...
export interface RemoteWorkspaceOptions {
    ...
    /**
     * An optional list of arbitrary commands to run before a remote Khulnasoft
