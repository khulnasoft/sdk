...
/**
 * {@link StepEventMetadata} describes a "step" within the Khulnasoft engine, which
...
/**
 * A Khulnasoft engine event, such as a change to a resource or diagnostic message.
...
export interface EngineEvent {
     ...
     * to the Khulnasoft Service. Since events may be sent concurrently, and/or
