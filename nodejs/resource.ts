...
/**
 * A constant to represent the "root stack" resource for a Khulnasoft application.
...
export interface CustomResourceOptions extends ResourceOptions {
     ...
     * This augments the list that the resource provider and Khulnasoft engine
...
export abstract class CustomResource extends Resource {
     ...
     * designed to work even when multiple copies of the Khulnasoft SDK have been
