...
khulnasoft.runtime.registerResourceModule("primitive", "index", _module)
khulnasoft.runtime.registerResourcePackage("primitive", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): khulnasoft.ProviderResource => {
        if (type !== "khulnasoft:providers:primitive") {
