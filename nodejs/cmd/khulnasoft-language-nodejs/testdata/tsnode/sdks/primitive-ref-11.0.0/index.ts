...
khulnasoft.runtime.registerResourceModule("primitive-ref", "index", _module)
khulnasoft.runtime.registerResourcePackage("primitive-ref", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): khulnasoft.ProviderResource => {
        if (type !== "khulnasoft:providers:primitive-ref") {
