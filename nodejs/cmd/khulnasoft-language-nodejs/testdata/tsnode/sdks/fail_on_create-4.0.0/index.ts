...
khulnasoft.runtime.registerResourceModule("fail_on_create", "index", _module)
khulnasoft.runtime.registerResourcePackage("fail_on_create", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): khulnasoft.ProviderResource => {
        if (type !== "khulnasoft:providers:fail_on_create") {
