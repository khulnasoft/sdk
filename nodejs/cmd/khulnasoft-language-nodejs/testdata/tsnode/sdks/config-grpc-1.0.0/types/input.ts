...
export interface TsecretBool1Args {
    secretX?: khulnasoft.Input<boolean>;
}
...
export interface TsecretInt1Args {
    secretX?: khulnasoft.Input<number>;
}
...
export interface TsecretString1Args {
    secretX?: khulnasoft.Input<string>;
}
