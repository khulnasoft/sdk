...
proto.codegen.GetMappingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    khulnasoftProvider: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
...
proto.codegen.GetMappingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setKhulnasoftProvider(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.codegen.GetMappingRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getKhulnasoftProvider();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
...
/**
 * optional string khulnasoft_provider = 2;
 * @return {string}
 */
proto.codegen.GetMappingRequest.prototype.getKhulnasoftProvider = function() {
 ...
 * @return {!proto.codegen.GetMappingRequest} returns this
 */
proto.codegen.GetMappingRequest.prototype.setKhulnasoftProvider = function(value) {
