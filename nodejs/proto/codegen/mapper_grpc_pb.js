...
var khulnasoft_codegen_mapper_pb = require('../codegen/mapper_pb.js');

function serialize_codegen_GetMappingRequest(arg) {
  if (!(arg instanceof khulnasoft_codegen_mapper_pb.GetMappingRequest)) {
...
function deserialize_codegen_GetMappingRequest(buffer_arg) {
  return khulnasoft_codegen_mapper_pb.GetMappingRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_codegen_GetMappingResponse(arg) {
  if (!(arg instanceof khulnasoft_codegen_mapper_pb.GetMappingResponse)) {
...
function deserialize_codegen_GetMappingResponse(buffer_arg) {
  return khulnasoft_codegen_mapper_pb.GetMappingResponse.deserializeBinary(new Uint8Array(buffer_arg));
}


// Mapper is a service for getting mappings from other ecosystems to Khulnasoft.
...
getMapping: {
    ...
    requestType: khulnasoft_codegen_mapper_pb.GetMappingRequest,
    responseType: khulnasoft_codegen_mapper_pb.GetMappingResponse,
