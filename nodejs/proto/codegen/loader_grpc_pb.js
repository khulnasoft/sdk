...
var khulnasoft_codegen_loader_pb = require('../codegen/loader_pb.js');

function serialize_codegen_GetSchemaRequest(arg) {
  if (!(arg instanceof khulnasoft_codegen_loader_pb.GetSchemaRequest)) {
...
function deserialize_codegen_GetSchemaRequest(buffer_arg) {
  return khulnasoft_codegen_loader_pb.GetSchemaRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_codegen_GetSchemaResponse(arg) {
  if (!(arg instanceof khulnasoft_codegen_loader_pb.GetSchemaResponse)) {
...
function deserialize_codegen_GetSchemaResponse(buffer_arg) {
  return khulnasoft_codegen_loader_pb.GetSchemaResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getSchema: {
    ...
    requestType: khulnasoft_codegen_loader_pb.GetSchemaRequest,
    responseType: khulnasoft_codegen_loader_pb.GetSchemaResponse,
