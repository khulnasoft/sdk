...
export class GetRequiredPackagesResponse extends jspb.Message { 
    ...
    getPackagesList(): Array<khulnasoft_plugin_pb.PackageDependency>;
    setPackagesList(value: Array<khulnasoft_plugin_pb.PackageDependency>): GetRequiredPackagesResponse;
    addPackages(value?: khulnasoft_plugin_pb.PackageDependency, index?: number): khulnasoft_plugin_pb.PackageDependency;
...
export namespace GetRequiredPackagesResponse {
    export type AsObject = {
        packagesList: Array<khulnasoft_plugin_pb.PackageDependency.AsObject>,
    }
}
