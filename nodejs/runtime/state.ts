...
const nodeEnvKeys = {
    project: "KHULNASOFT_NODEJS_PROJECT",
    stack: "KHULNASOFT_NODEJS_STACK",
    dryRun: "KHULNASOFT_NODEJS_DRY_RUN",
    queryMode: "KHULNASOFT_NODEJS_QUERY_MODE",
    parallel: "KHULNASOFT_NODEJS_PARALLEL",
    monitorAddr: "KHULNASOFT_NODEJS_MONITOR",
    engineAddr: "KHULNASOFT_NODEJS_ENGINE",
    syncDir: "KHULNASOFT_NODEJS_SYNC",

    // Unlike the values above, this value is not set by the CLI and is
    // controlled via a user-set environment variable.
    cacheDynamicProviders: "KHULNASOFT_NODEJS_CACHE_DYNAMIC_PROVIDERS",

    organization: "KHULNASOFT_NODEJS_ORGANIZATION",
};

const khulnasoftEnvKeys = {
    legacyApply: "KHULNASOFT_ENABLE_LEGACY_APPLY",
};
