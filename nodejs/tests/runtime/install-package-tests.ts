...
// A simple TypeScript Khulnasoft program to test that we can load and run TypeScript code.
...
backend:
  url: 'file://~'
`;
    await fs.writeFile(path.join(dir, "Khulnasoft.yaml"), project);
}
