This test validates that changes we're making in @khulnasoft/khulnasoft will be side-by-side compatible with the 'latest' version of `@khulnasoft/khulnasoft` that has already shipped.
