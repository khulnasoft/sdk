...
func (x *PackageParameterization) Reset() {
	*x = PackageParameterization{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_plugin_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PackageParameterization) Descriptor() ([]byte, []int) {
	return file_khulnasoft_plugin_proto_rawDescGZIP(), []int{3}
}
...
func (x *PackageDependency) Reset() {
	*x = PackageDependency{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_plugin_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PackageDependency) Descriptor() ([]byte, []int) {
	return file_khulnasoft_plugin_proto_rawDescGZIP(), []int{4}
}
...
var file_khulnasoft_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_khulnasoft_plugin_proto_goTypes = []interface{}{
	...
	(*PackageParameterization)(nil), // 3: khulnasoftrpc.PackageParameterization
	(*PackageDependency)(nil),       // 4: khulnasoftrpc.PackageDependency
	nil,                             // 5: khulnasoftrpc.PluginDependency.ChecksumsEntry
	nil,                             // 6: khulnasoftrpc.PackageDependency.ChecksumsEntry
}
var file_khulnasoft_plugin_proto_depIdxs = []int32{
	5, // 0: khulnasoftrpc.PluginDependency.checksums:type_name -> khulnasoftrpc.PluginDependency.ChecksumsEntry
	6, // 1: khulnasoftrpc.PackageDependency.checksums:type_name -> khulnasoftrpc.PackageDependency.ChecksumsEntry
	3, // 2: khulnasoftrpc.PackageDependency.parameterization:type_name -> khulnasoftrpc.PackageParameterization
...
func file_khulnasoft_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_khulnasoft_plugin_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_plugin_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
