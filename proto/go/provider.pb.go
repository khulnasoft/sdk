...
func (CheckRequest_AutonamingOptions_Mode) EnumDescriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{13, 0, 0}
}
...
func (PropertyDiff_Kind) EnumDescriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{17, 0}
}
...
func (DiffResponse_DiffChanges) Descriptor() protoreflect.EnumDescriptor {
	return file_khulnasoft_provider_proto_enumTypes[2].Descriptor()
}

func (DiffResponse_DiffChanges) Type() protoreflect.EnumType {
	return &file_khulnasoft_provider_proto_enumTypes[2]
}
...
func (DiffResponse_DiffChanges) EnumDescriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{18, 0}
}

// `ProviderHandshakeRequest` is the type of requests sent as part of a [](khulnasoftrpc.ResourceProvider.Handshake) call.
type ProviderHandshakeRequest struct {
	...
	// of the [](khulnasoftrpc.Engine) service.
...
// `ProviderHandshakeResponse` is the type of responses sent by a [](khulnasoftrpc.ResourceProvider.Handshake) call.
...
type ConfigureRequest struct {
	...
	// [](khulnasoftrpc.ResourceProvider.Handshake).
	...
	// these calls. *Must* be true if the caller has previously called [](khulnasoftrpc.ResourceProvider.Handshake).
...
type ConfigureResponse struct {
	...
	// values to the provider. *Must* be true if the provider implements [](khulnasoftrpc.ResourceProvider.Handshake).
	...
	// `true` during previews. *Must* be true if the provider implements [](khulnasoftrpc.ResourceProvider.Handshake).
...
type CheckRequest struct {
	...
	// differ from those written in the Khulnasoft program registering this resource. In such cases, the caller (e.g. the
	// Khulnasoft engine) is expected to preprocess the `news` value by replacing every property matched by `ignoreChanges`
...
// persisted to Khulnasoft state and passed to subsequent calls.
...
type DiffResponse struct {
	...
	// property located at that path. If a provider does not implement this, the caller (typically the Khulnasoft engine)
...
type ConstructRequest struct {
	...
	// nested resources) are removed from a Khulnasoft program.
...
// converted from a source markup to Khulnasoft. It's expected that provider bridges that target a given ecosystem
// (e.g. Terraform, Kubernetes) would also publish a conversion plugin to convert markup from that ecosystem
// to Khulnasoft, using the bridged providers.
...
type GetMappingResponse struct {
	...
	// the provider key this is mapping for. For example the Khulnasoft provider "terraform-template" would return "template" for this.
...
func (*GetMappingsRequest) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{31}
}
...
type GetMappingsResponse struct {
	...
	// the provider keys this provider can supply mappings for. For example the Khulnasoft provider "terraform-template"
...
func (*GetMappingsResponse) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{32}
}
...
func (x *ParameterizeRequest_ParametersArgs) Reset() {
	*x = ParameterizeRequest_ParametersArgs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ParameterizeRequest_ParametersArgs) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{2, 0}
}
...
func (*ParameterizeRequest_ParametersValue) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{2, 1}
}
...
type ConfigureErrorMissingKeys_MissingKey struct {
	...
	//
	// :::{note}
	// This should be the *Khulnasoft name* of the missing key, and not any provider-internal or upstream name. Names
	// that differ between Khulnasoft and an upstream provider should be translated prior to being returned.
	// :::
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
...
func (x *ConfigureErrorMissingKeys_MissingKey) Reset() {
	*x = ConfigureErrorMissingKeys_MissingKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConfigureErrorMissingKeys_MissingKey) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *CallRequest_ArgumentDependencies) Reset() {
	*x = CallRequest_ArgumentDependencies{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CallRequest_ArgumentDependencies) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *CallResponse_ReturnDependencies) Reset() {
	*x = CallResponse_ReturnDependencies{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CallResponse_ReturnDependencies) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{12, 0}
}
...
type CheckRequest_AutonamingOptions struct {
	...
	Mode         CheckRequest_AutonamingOptions_Mode `protobuf:"varint,2,opt,name=mode,proto3,enum=khulnasoftrpc.CheckRequest_AutonamingOptions_Mode" json:"mode,omitempty"`
}
...
func (*CheckRequest_AutonamingOptions) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{13, 0}
}
...
func (x *ConstructRequest_PropertyDependencies) Reset() {
	*x = ConstructRequest_PropertyDependencies{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[44]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConstructRequest_PropertyDependencies) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{26, 0}
}
...
func (x *ConstructRequest_CustomTimeouts) Reset() {
	*x = ConstructRequest_CustomTimeouts{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[45]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConstructRequest_CustomTimeouts) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{26, 1}
}
...
func (x *ConstructResponse_PropertyDependencies) Reset() {
	*x = ConstructResponse_PropertyDependencies{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_provider_proto_msgTypes[49]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConstructResponse_PropertyDependencies) Descriptor() ([]byte, []int) {
	return file_khulnasoft_provider_proto_rawDescGZIP(), []int{27, 0}
}
...
var file_khulnasoft_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_khulnasoft_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_khulnasoft_provider_proto_goTypes = []interface{}{
	(CheckRequest_AutonamingOptions_Mode)(0),    // 0: khulnasoftrpc.CheckRequest.AutonamingOptions.Mode
	(PropertyDiff_Kind)(0),                      // 1: khulnasoftrpc.PropertyDiff.Kind
	(DiffResponse_DiffChanges)(0),               // 2: khulnasoftrpc.DiffResponse.DiffChanges
	(*ProviderHandshakeRequest)(nil),            // 3: khulnasoftrpc.ProviderHandshakeRequest
	(*ProviderHandshakeResponse)(nil),           // 4: khulnasoftrpc.ProviderHandshakeResponse
	(*ParameterizeRequest)(nil),                 // 5: khulnasoftrpc.ParameterizeRequest
	(*ParameterizeResponse)(nil),                // 6: khulnasoftrpc.ParameterizeResponse
	(*GetSchemaRequest)(nil),                    // 7: khulnasoftrpc.GetSchemaRequest
	(*GetSchemaResponse)(nil),                   // 8: khulnasoftrpc.GetSchemaResponse
	(*ConfigureRequest)(nil),                    // 9: khulnasoftrpc.ConfigureRequest
	(*ConfigureResponse)(nil),                   // 10: khulnasoftrpc.ConfigureResponse
	(*ConfigureErrorMissingKeys)(nil),           // 11: khulnasoftrpc.ConfigureErrorMissingKeys
	(*InvokeRequest)(nil),                       // 12: khulnasoftrpc.InvokeRequest
	(*InvokeResponse)(nil),                      // 13: khulnasoftrpc.InvokeResponse
	(*CallRequest)(nil),                         // 14: khulnasoftrpc.CallRequest
	(*CallResponse)(nil),                        // 15: khulnasoftrpc.CallResponse
	(*CheckRequest)(nil),                        // 16: khulnasoftrpc.CheckRequest
	(*CheckResponse)(nil),                       // 17: khulnasoftrpc.CheckResponse
	(*CheckFailure)(nil),                        // 18: khulnasoftrpc.CheckFailure
	(*DiffRequest)(nil),                         // 19: khulnasoftrpc.DiffRequest
	(*PropertyDiff)(nil),                        // 20: khulnasoftrpc.PropertyDiff
	(*DiffResponse)(nil),                        // 21: khulnasoftrpc.DiffResponse
	(*CreateRequest)(nil),                       // 22: khulnasoftrpc.CreateRequest
	(*CreateResponse)(nil),                      // 23: khulnasoftrpc.CreateResponse
	(*ReadRequest)(nil),                         // 24: khulnasoftrpc.ReadRequest
	(*ReadResponse)(nil),                        // 25: khulnasoftrpc.ReadResponse
	(*UpdateRequest)(nil),                       // 26: khulnasoftrpc.UpdateRequest
	(*UpdateResponse)(nil),                      // 27: khulnasoftrpc.UpdateResponse
	(*DeleteRequest)(nil),                       // 28: khulnasoftrpc.DeleteRequest
	(*ConstructRequest)(nil),                    // 29: khulnasoftrpc.ConstructRequest
	(*ConstructResponse)(nil),                   // 30: khulnasoftrpc.ConstructResponse
	(*ErrorResourceInitFailed)(nil),             // 31: khulnasoftrpc.ErrorResourceInitFailed
	(*GetMappingRequest)(nil),                   // 32: khulnasoftrpc.GetMappingRequest
	(*GetMappingResponse)(nil),                  // 33: khulnasoftrpc.GetMappingResponse
	(*GetMappingsRequest)(nil),                  // 34: khulnasoftrpc.GetMappingsRequest
	(*GetMappingsResponse)(nil),                 // 35: khulnasoftrpc.GetMappingsResponse
	(*ParameterizeRequest_ParametersArgs)(nil),  // 36: khulnasoftrpc.ParameterizeRequest.ParametersArgs
	(*ParameterizeRequest_ParametersValue)(nil), // 37: khulnasoftrpc.ParameterizeRequest.ParametersValue
	nil, // 38: khulnasoftrpc.ConfigureRequest.VariablesEntry
	(*ConfigureErrorMissingKeys_MissingKey)(nil), // 39: khulnasoftrpc.ConfigureErrorMissingKeys.MissingKey
	(*CallRequest_ArgumentDependencies)(nil),     // 40: khulnasoftrpc.CallRequest.ArgumentDependencies
	nil,                                          // 41: khulnasoftrpc.CallRequest.ArgDependenciesEntry
	nil,                                          // 42: khulnasoftrpc.CallRequest.ConfigEntry
	(*CallResponse_ReturnDependencies)(nil),      // 43: khulnasoftrpc.CallResponse.ReturnDependencies
	nil,                                          // 44: khulnasoftrpc.CallResponse.ReturnDependenciesEntry
	(*CheckRequest_AutonamingOptions)(nil),       // 45: khulnasoftrpc.CheckRequest.AutonamingOptions
	nil,                                          // 46: khulnasoftrpc.DiffResponse.DetailedDiffEntry
	(*ConstructRequest_PropertyDependencies)(nil), // 47: khulnasoftrpc.ConstructRequest.PropertyDependencies
	(*ConstructRequest_CustomTimeouts)(nil),       // 48: khulnasoftrpc.ConstructRequest.CustomTimeouts
	nil,                                           // 49: khulnasoftrpc.ConstructRequest.ConfigEntry
	nil,                                           // 50: khulnasoftrpc.ConstructRequest.InputDependenciesEntry
	nil,                                           // 51: khulnasoftrpc.ConstructRequest.ProvidersEntry
	(*ConstructResponse_PropertyDependencies)(nil), // 52: khulnasoftrpc.ConstructResponse.PropertyDependencies
	nil,                     // 53: khulnasoftrpc.ConstructResponse.StateDependenciesEntry
	(*structpb.Struct)(nil), // 54: google.protobuf.Struct
	(*emptypb.Empty)(nil),   // 55: google.protobuf.Empty
	(*PluginAttach)(nil),    // 56: khulnasoftrpc.PluginAttach
	(*PluginInfo)(nil),      // 57: khulnasoftrpc.PluginInfo
}
var file_khulnasoft_provider_proto_depIdxs = []int32{
	36, // 0: khulnasoftrpc.ParameterizeRequest.args:type_name -> khulnasoftrpc.ParameterizeRequest.ParametersArgs
	37, // 1: khulnasoftrpc.ParameterizeRequest.value:type_name -> khulnasoftrpc.ParameterizeRequest.ParametersValue
	38, // 2: khulnasoftrpc.ConfigureRequest.variables:type_name -> khulnasoftrpc.ConfigureRequest.VariablesEntry
	54, // 3: khulnasoftrpc.ConfigureRequest.args:type_name -> google.protobuf.Struct
	39, // 4: khulnasoftrpc.ConfigureErrorMissingKeys.missingKeys:type_name -> khulnasoftrpc.ConfigureErrorMissingKeys.MissingKey
	54, // 5: khulnasoftrpc.InvokeRequest.args:type_name -> google.protobuf.Struct
	54, // 6: khulnasoftrpc.InvokeResponse.return:type_name -> google.protobuf.Struct
	18, // 7: khulnasoftrpc.InvokeResponse.failures:type_name -> khulnasoftrpc.CheckFailure
	54, // 8: khulnasoftrpc.CallRequest.args:type_name -> google.protobuf.Struct
	41, // 9: khulnasoftrpc.CallRequest.argDependencies:type_name -> khulnasoftrpc.CallRequest.ArgDependenciesEntry
	42, // 10: khulnasoftrpc.CallRequest.config:type_name -> khulnasoftrpc.CallRequest.ConfigEntry
	54, // 11: khulnasoftrpc.CallResponse.return:type_name -> google.protobuf.Struct
	18, // 12: khulnasoftrpc.CallResponse.failures:type_name -> khulnasoftrpc.CheckFailure
	44, // 13: khulnasoftrpc.CallResponse.returnDependencies:type_name -> khulnasoftrpc.CallResponse.ReturnDependenciesEntry
	54, // 14: khulnasoftrpc.CheckRequest.olds:type_name -> google.protobuf.Struct
	54, // 15: khulnasoftrpc.CheckRequest.news:type_name -> google.protobuf.Struct
	45, // 16: khulnasoftrpc.CheckRequest.autonaming:type_name -> khulnasoftrpc.CheckRequest.AutonamingOptions
	54, // 17: khulnasoftrpc.CheckResponse.inputs:type_name -> google.protobuf.Struct
	18, // 18: khulnasoftrpc.CheckResponse.failures:type_name -> khulnasoftrpc.CheckFailure
	54, // 19: khulnasoftrpc.DiffRequest.olds:type_name -> google.protobuf.Struct
	54, // 20: khulnasoftrpc.DiffRequest.news:type_name -> google.protobuf.Struct
	54, // 21: khulnasoftrpc.DiffRequest.old_inputs:type_name -> google.protobuf.Struct
	1,  // 22: khulnasoftrpc.PropertyDiff.kind:type_name -> khulnasoftrpc.PropertyDiff.Kind
	2,  // 23: khulnasoftrpc.DiffResponse.changes:type_name -> khulnasoftrpc.DiffResponse.DiffChanges
	46, // 24: khulnasoftrpc.DiffResponse.detailedDiff:type_name -> khulnasoftrpc.DiffResponse.DetailedDiffEntry
	54, // 25: khulnasoftrpc.CreateRequest.properties:type_name -> google.protobuf.Struct
	54, // 26: khulnasoftrpc.CreateResponse.properties:type_name -> google.protobuf.Struct
	54, // 27: khulnasoftrpc.ReadRequest.properties:type_name -> google.protobuf.Struct
	54, // 28: khulnasoftrpc.ReadRequest.inputs:type_name -> google.protobuf.Struct
	54, // 29: khulnasoftrpc.ReadResponse.properties:type_name -> google.protobuf.Struct
	54, // 30: khulnasoftrpc.ReadResponse.inputs:type_name -> google.protobuf.Struct
	54, // 31: khulnasoftrpc.UpdateRequest.olds:type_name -> google.protobuf.Struct
	54, // 32: khulnasoftrpc.UpdateRequest.news:type_name -> google.protobuf.Struct
	54, // 33: khulnasoftrpc.UpdateRequest.old_inputs:type_name -> google.protobuf.Struct
	54, // 34: khulnasoftrpc.UpdateResponse.properties:type_name -> google.protobuf.Struct
	54, // 35: khulnasoftrpc.DeleteRequest.properties:type_name -> google.protobuf.Struct
	54, // 36: khulnasoftrpc.DeleteRequest.old_inputs:type_name -> google.protobuf.Struct
	49, // 37: khulnasoftrpc.ConstructRequest.config:type_name -> khulnasoftrpc.ConstructRequest.ConfigEntry
	54, // 38: khulnasoftrpc.ConstructRequest.inputs:type_name -> google.protobuf.Struct
	50, // 39: khulnasoftrpc.ConstructRequest.inputDependencies:type_name -> khulnasoftrpc.ConstructRequest.InputDependenciesEntry
	51, // 40: khulnasoftrpc.ConstructRequest.providers:type_name -> khulnasoftrpc.ConstructRequest.ProvidersEntry
	48, // 41: khulnasoftrpc.ConstructRequest.customTimeouts:type_name -> khulnasoftrpc.ConstructRequest.CustomTimeouts
	54, // 42: khulnasoftrpc.ConstructResponse.state:type_name -> google.protobuf.Struct
	53, // 43: khulnasoftrpc.ConstructResponse.stateDependencies:type_name -> khulnasoftrpc.ConstructResponse.StateDependenciesEntry
	54, // 44: khulnasoftrpc.ErrorResourceInitFailed.properties:type_name -> google.protobuf.Struct
	54, // 45: khulnasoftrpc.ErrorResourceInitFailed.inputs:type_name -> google.protobuf.Struct
	40, // 46: khulnasoftrpc.CallRequest.ArgDependenciesEntry.value:type_name -> khulnasoftrpc.CallRequest.ArgumentDependencies
	43, // 47: khulnasoftrpc.CallResponse.ReturnDependenciesEntry.value:type_name -> khulnasoftrpc.CallResponse.ReturnDependencies
	0,  // 48: khulnasoftrpc.CheckRequest.AutonamingOptions.mode:type_name -> khulnasoftrpc.CheckRequest.AutonamingOptions.Mode
	20, // 49: khulnasoftrpc.DiffResponse.DetailedDiffEntry.value:type_name -> khulnasoftrpc.PropertyDiff
	47, // 50: khulnasoftrpc.ConstructRequest.InputDependenciesEntry.value:type_name -> khulnasoftrpc.ConstructRequest.PropertyDependencies
	52, // 51: khulnasoftrpc.ConstructResponse.StateDependenciesEntry.value:type_name -> khulnasoftrpc.ConstructResponse.PropertyDependencies
	3,  // 52: khulnasoftrpc.ResourceProvider.Handshake:input_type -> khulnasoftrpc.ProviderHandshakeRequest
	5,  // 53: khulnasoftrpc.ResourceProvider.Parameterize:input_type -> khulnasoftrpc.ParameterizeRequest
	7,  // 54: khulnasoftrpc.ResourceProvider.GetSchema:input_type -> khulnasoftrpc.GetSchemaRequest
	16, // 55: khulnasoftrpc.ResourceProvider.CheckConfig:input_type -> khulnasoftrpc.CheckRequest
	19, // 56: khulnasoftrpc.ResourceProvider.DiffConfig:input_type -> khulnasoftrpc.DiffRequest
	9,  // 57: khulnasoftrpc.ResourceProvider.Configure:input_type -> khulnasoftrpc.ConfigureRequest
	12, // 58: khulnasoftrpc.ResourceProvider.Invoke:input_type -> khulnasoftrpc.InvokeRequest
	12, // 59: khulnasoftrpc.ResourceProvider.StreamInvoke:input_type -> khulnasoftrpc.InvokeRequest
	14, // 60: khulnasoftrpc.ResourceProvider.Call:input_type -> khulnasoftrpc.CallRequest
	16, // 61: khulnasoftrpc.ResourceProvider.Check:input_type -> khulnasoftrpc.CheckRequest
	19, // 62: khulnasoftrpc.ResourceProvider.Diff:input_type -> khulnasoftrpc.DiffRequest
	22, // 63: khulnasoftrpc.ResourceProvider.Create:input_type -> khulnasoftrpc.CreateRequest
	24, // 64: khulnasoftrpc.ResourceProvider.Read:input_type -> khulnasoftrpc.ReadRequest
	26, // 65: khulnasoftrpc.ResourceProvider.Update:input_type -> khulnasoftrpc.UpdateRequest
	28, // 66: khulnasoftrpc.ResourceProvider.Delete:input_type -> khulnasoftrpc.DeleteRequest
	29, // 67: khulnasoftrpc.ResourceProvider.Construct:input_type -> khulnasoftrpc.ConstructRequest
	55, // 68: khulnasoftrpc.ResourceProvider.Cancel:input_type -> google.protobuf.Empty
	55, // 69: khulnasoftrpc.ResourceProvider.GetPluginInfo:input_type -> google.protobuf.Empty
	56, // 70: khulnasoftrpc.ResourceProvider.Attach:input_type -> khulnasoftrpc.PluginAttach
	32, // 71: khulnasoftrpc.ResourceProvider.GetMapping:input_type -> khulnasoftrpc.GetMappingRequest
	34, // 72: khulnasoftrpc.ResourceProvider.GetMappings:input_type -> khulnasoftrpc.GetMappingsRequest
	4,  // 73: khulnasoftrpc.ResourceProvider.Handshake:output_type -> khulnasoftrpc.ProviderHandshakeResponse
	6,  // 74: khulnasoftrpc.ResourceProvider.Parameterize:output_type -> khulnasoftrpc.ParameterizeResponse
	8,  // 75: khulnasoftrpc.ResourceProvider.GetSchema:output_type -> khulnasoftrpc.GetSchemaResponse
	17, // 76: khulnasoftrpc.ResourceProvider.CheckConfig:output_type -> khulnasoftrpc.CheckResponse
	21, // 77: khulnasoftrpc.ResourceProvider.DiffConfig:output_type -> khulnasoftrpc.DiffResponse
	10, // 78: khulnasoftrpc.ResourceProvider.Configure:output_type -> khulnasoftrpc.ConfigureResponse
	13, // 79: khulnasoftrpc.ResourceProvider.Invoke:output_type -> khulnasoftrpc.InvokeResponse
	13, // 80: khulnasoftrpc.ResourceProvider.StreamInvoke:output_type -> khulnasoftrpc.InvokeResponse
	15, // 81: khulnasoftrpc.ResourceProvider.Call:output_type -> khulnasoftrpc.CallResponse
	17, // 82: khulnasoftrpc.ResourceProvider.Check:output_type -> khulnasoftrpc.CheckResponse
	21, // 83: khulnasoftrpc.ResourceProvider.Diff:output_type -> khulnasoftrpc.DiffResponse
	23, // 84: khulnasoftrpc.ResourceProvider.Create:output_type -> khulnasoftrpc.CreateResponse
	25, // 85: khulnasoftrpc.ResourceProvider.Read:output_type -> khulnasoftrpc.ReadResponse
	27, // 86: khulnasoftrpc.ResourceProvider.Update:output_type -> khulnasoftrpc.UpdateResponse
	55, // 87: khulnasoftrpc.ResourceProvider.Delete:output_type -> google.protobuf.Empty
	30, // 88: khulnasoftrpc.ResourceProvider.Construct:output_type -> khulnasoftrpc.ConstructResponse
	55, // 89: khulnasoftrpc.ResourceProvider.Cancel:output_type -> google.protobuf.Empty
	57, // 90: khulnasoftrpc.ResourceProvider.GetPluginInfo:output_type -> khulnasoftrpc.PluginInfo
	55, // 91: khulnasoftrpc.ResourceProvider.Attach:output_type -> google.protobuf.Empty
	33, // 92: khulnasoftrpc.ResourceProvider.GetMapping:output_type -> khulnasoftrpc.GetMappingResponse
	35, // 93: khulnasoftrpc.ResourceProvider.GetMappings:output_type -> khulnasoftrpc.GetMappingsResponse
...
func file_khulnasoft_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_khulnasoft_provider_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_provider_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
	...
	file_khulnasoft_provider_proto_msgTypes[2].OneofWrappers = []interface{}{
