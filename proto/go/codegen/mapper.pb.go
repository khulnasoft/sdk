...
// convert provider types from a source markup to Khulnasoft.
type GetMappingRequest struct {
	...
	KhulnasoftProvider string `protobuf:"bytes,2,opt,name=khulnasoft_provider,json=khulnasoftProvider,proto3" json:"khulnasoft_provider,omitempty"`
}
...
func (x *GetMappingRequest) GetKhulnasoftProvider() string {
	if x != nil {
		return x.KhulnasoftProvider
	}
	return ""
}
